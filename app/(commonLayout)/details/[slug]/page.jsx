        ...
        <Tabs defaultValue="description" className="mt-[100px] my-8">
          <TabsList className="border-b border-gray-200 w-full">
            <div className="container mx-auto space-x-4 sm:space-x-10 sm:px-8">
              <TabsTrigger
                value="description"
                className="border-gray-900 text-gray-200 flex-1 whitespace-nowrap px-1 py-2 text-base font-bold data-[state=active]:text-gray-900 data-[state=active]:bg-transparent data-[state=active]:border-b-2"
              >
                Description
              </TabsTrigger>
              <TabsTrigger
