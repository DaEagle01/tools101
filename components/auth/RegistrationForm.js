      ...
      {showForm ? (
        <form className="w-full" onSubmit={handleSubmit(onSubmit)}>
          <div className="mb-2">
            ...
            <div
              className={`relative flex items-center rounded-xl border ${errors.full_name?.message ? "border-red-400" : ""
                } overflow-hidden`}
            >
              <input
                {...register("full_name")}
          ...
          <div className="mb-2">
            ...
            <div
              className={`relative flex items-center rounded-xl border ${errors.login_name?.message ? "border-red-400" : ""
                } overflow-hidden`}
            >
              <input
                {...register("login_name")}
          ...
          <div className="mb-2">
            ...
            <div
              className={`relative flex items-center border h-12 rounded-tl-xl rounded-r-xl overflow-hidden ${errors.phone?.message ? "border-red-400" : ""
                }`}
            >
          ...
          <div className="mb-2">
            ...
            <div
              className={`relative flex items-center rounded-xl border ${errors.email?.message ? "border-red-400" : ""
                } overflow-hidden`}
            >
              <input
                {...register("email")}
          ...
          <div className="mb-2">
            ...
            <div
              className={`relative flex items-center rounded-xl border overflow-hidden ${errors.password ? "border-red-400" : ""
                }`}
            >
              <input
                {...register("password")}
          ...
          <div className="mb-4">
            ...
            <div
              className={`relative flex items-center rounded-xl border overflow-hidden ${errors.confirmPassword ? "border-red-400" : ""
                }`}
            >
              <input
